...
y_index = Ny // 2
plot = ax.imshow(a30[:, y_index, :].T, extent=extent, vmin=0, vmax=2, cmap='jet', interpolation='gaussian')
cbar = plt.colorbar(plot, ax=ax, pad=0.01)
cbar.set_ticks([0, 1, 2])
cbar.set_ticklabels(['0', '1', '2'])
plt.savefig('../../../plots/spin-2/paper/UN-BN_SV-SV_singlet_longitudinal.png', bbox_inches='tight', dpi=200)
plt.show()
