...
ax.plot(r, mod_f, "k", label=r"$|\langle\mathbf{\hat{F}}(\mathbf{r})\rangle|$")
ax.plot(r, mod_a30_C_FM, "k--", label=r"$|A_{30}(\mathbf{r})|^2$")
...
plt.savefig(
    "../plots/spin-2/spin_singlet_radius_analytical.pdf", bbox_inches="tight"
)
plt.show()
